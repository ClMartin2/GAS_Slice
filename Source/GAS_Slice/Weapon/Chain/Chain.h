...
#pragma region Settings PhysicsConstraint MiddleConstraint
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Settings|PhysicsConstraint|MiddleContraint",
...
public :
	...
	void SetComponentToAttachEnd(USceneComponent* EndComponentToAttach)
	{
		ComponentToAttachEndTo = EndComponentToAttach;
	}
...
protected:
	...
	UPhysicsConstraintComponent* CreatePhysicsConstraint(UPrimitiveComponent* FirstComponent,
	                                                     UPrimitiveComponent* SecondComponent, FVector Location, bool
